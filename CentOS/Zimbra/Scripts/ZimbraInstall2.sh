...
if [ "$4" == "bind" ]; then
    yum update -y && yum install -y perl bind bind-utils
...
# https://forums.zimbra.org/viewtopic.php?t=59663
# https://dilliganesh.wordpress.com/2016/10/11/how-to-change-ip-address-of-zimbra-mail-server/

# Modificar IP
# su zimbra
# zmprov modifyServer mail.kibanosos.net zimbraMtaMyNetworks '127.0.0.0/8 172.16.0.0/32'
# postfix reload
# postconf mynetworks
# mynetworks = 127.0.0.0/8 172.16.200.200/32